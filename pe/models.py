...
class Estimate(models.Model):
  ...
  eps1 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
  eps2 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
  eps3 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
  eps4 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
